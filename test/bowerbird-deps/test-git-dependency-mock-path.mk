...
expected-git-dependency-mock-path := \
	$(call bowerbird::core::test-fixture::expected-git-dependency,branch,https://github.com/example/test-repo.git,$(WORKDIR_TEST)/test-git-dependency-mock-path/deps/vendor/mock-dep,main,bowerbird.mk)
