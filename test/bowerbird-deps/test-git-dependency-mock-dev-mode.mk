...
expected-git-dependency-mock-dev-mode := \
	$(call bowerbird::core::test-fixture::expected-git-dependency,dev-mode,https://mock.com/repo.git,$(WORKDIR_TEST)/test-git-dependency-mock-dev-mode/deps,develop,main.mk)
